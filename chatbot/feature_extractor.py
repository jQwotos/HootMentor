...
word_vector.wv.save_word2vec_format(u"saver/word_vector.bin", binary=True)
...
#     len_a_list.append(len_a)
#     len_b_list.append(len_b)
# np.save("data/lenmax22_former-sents2_a_list", np.array(len_a_list))
# np.save("data/lenmax22_former-sents2_b_list", np.array(len_b_list))
# print("max_a_ind {}, max_b_ind {}".format(max_a_ind, max_b_ind))
# print("max_a {}, max_b {}, avg_a {}, avg_b {}".format(max_a, max_b, sum_a/len(conversations), sum_b/len(conversations)))
...
#     len_a_list.append(len_a)
#     len_b_list.append(len_b)
# np.save("data/lenmax22_a_list", np.array(len_a_list))
# np.save("data/lenmax22_b_list", np.array(len_b_list))
# print("max_a_ind {}, max_b_ind {}".format(max_a_ind, max_b_ind))
# print("max_a {}, max_b {}, avg_a {}, avg_b {}".format(max_a, max_b, sum_a/len(conversations), sum_b/len(conversations)))
